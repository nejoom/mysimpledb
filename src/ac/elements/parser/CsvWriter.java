...
public class CsvWriter {
    ...
    private boolean useCustomRecordDelimiter = true;
    ...
    public char getRecordDelimiterAsChar() {
        return userSettings.RecordDelimiter.charAt(0);
    }
    ...
    public void setRecordDelimiter(char recordDelimiter) {
        ...
        userSettings.RecordDelimiter = Character.toString(recordDelimiter);
    }
    ...
    public void write(String content, boolean preserveSpaces)
        ...
        if (textQualify) {
            ...
            if (userSettings.EscapeMode == ESCAPE_MODE_BACKSLASH) {
                content =
                        replace(content, "" + Letters.BACKSLASH, ""
                                + Letters.BACKSLASH + Letters.BACKSLASH);
                content =
                        replace(content, "" + userSettings.TextQualifier, ""
                                + Letters.BACKSLASH
            ...
            content =
                    replace(content, "" + Letters.BACKSLASH, ""
                            + Letters.BACKSLASH + Letters.BACKSLASH);
            content =
                    replace(content, "" + userSettings.Delimiter, ""
                            + Letters.BACKSLASH + userSettings.Delimiter);

            if (useCustomRecordDelimiter) {
                content =
                        replace(content, "" + userSettings.RecordDelimiter, ""
                                + Letters.BACKSLASH
                                + userSettings.RecordDelimiter);
            } else {
                content =
                        replace(content, "" + Letters.CR, ""
                                + Letters.BACKSLASH + Letters.CR);
                content =
                        replace(content, "" + Letters.LF, ""
