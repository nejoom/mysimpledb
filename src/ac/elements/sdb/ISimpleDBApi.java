...
/**
 * <p>
 * This interface defines Amazon's Simple DB API as defined in:
 * http://docs.amazonwebservices
 * .com/AmazonSimpleDB/2009-04-15/DeveloperGuide/index
 * .html?SDB_API_Operations.html
 * 
 */
public interface ISimpleDBApi {
     ...
     *            the domain
     * @param sdbMap
     *            the sdbMap with the item name and attributes
     * 
     * @return the xml response as a string
     */
